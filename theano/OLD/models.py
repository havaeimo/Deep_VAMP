...
class HiddenLayer(object):
    def __init__(self, rng,layerIdx, input, n_in, n_out, W=None, b=None,
                 activation=T.tanh):
        """
        ...
        if b is None:
            ...
            b = theano.shared(value=b_values, name='W{}'.format(layerIdx), borrow=True)
...
class LogisticRegression(object):
    ...
    def __init__(self, input,layerIdx, n_in, n_out):
